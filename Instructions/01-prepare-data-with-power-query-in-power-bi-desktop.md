...
- Utiliser les outils de profil de données
...
### **Tâche 1 : Bien démarrer avec Power BI Desktop**

Dans cette tâche, vous commencez par ouvrir un fichier Power BI de démarrage (.pbix). Le fichier de démarrage ne contient aucune donnée, mais a été spécialement configuré pour vous aider à suivre le labo. Les paramètres au niveau du rapport suivants ont été désactivés dans le fichier de démarrage :
...
### **Tâche 2 : Obtenir des données à partir de SQL Server**
...
### **Tâche 3 : Afficher un aperçu des données dans l’Éditeur Power Query**
...
### **Tâche 4 : Obtenir des données à partir d’un fichier CSV**
