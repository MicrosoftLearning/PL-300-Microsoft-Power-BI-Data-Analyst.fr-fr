...
1. Dans la zone**Recherche**, entrez_Disposition_.

1. Définissez la propriété**Disposition** sur_Tabulaire_.
...
1. Dans la**vue Modèle**, placez les trois nouvelles mesures dans un dossier d’affichage nommé_Ratios_.
