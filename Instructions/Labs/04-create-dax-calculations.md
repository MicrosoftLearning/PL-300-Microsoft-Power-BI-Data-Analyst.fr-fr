...
1. Dans le volet **Données**, sélectionnez le champ `Month`.
...
1. Dans la fenêtre **Marquer comme table de dates**, faites glisser la propriété **Marquer comme table de dates** sur _Activé_.
