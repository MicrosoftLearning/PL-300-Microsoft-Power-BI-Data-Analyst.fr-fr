...
Dans ce labo, vous allez appliquer la sécurité au niveau des lignes pour vous assurer qu’un vendeur ne peut analyser les données de ventes que pour la ou les régions qui lui sont affectées. Vous allez apprendre à effectuer les actions suivantes :

- Implémentez la sécurité dynamique au niveau des lignes (RLS) dans Power BI.
- Créez et testez un rôle à l’aide de USERPRINCIPALNAME().
...
1. Pour attribuer un filtre, sélectionnez le tableau **Commercial (Performance)**, puis sélectionnez **Passer à l’éditeur DAX** dans la section **Règles**.
...
1. Notez la bannière rouge au-dessus de la page du rapport, qui décrit le contexte de sécurité du test.
...
1. Pour arrêter le test, à droite de la bannière rouge, sélectionnez **Arrêter l’affichage**.
